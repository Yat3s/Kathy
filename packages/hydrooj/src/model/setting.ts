...
AccountSetting(
    ...
    Setting('setting_info', 'phone', null, 'text', 'Phone'),
...
SystemSetting(
    ...
    Setting('setting_server', 'server.name', 'QINGYA', 'text', 'server.name', 'Server Name'),
    Setting('setting_server', 'server.displayName', 'QINGYA', 'text', 'server.name', 'Server Name (Global Display)', FLAG_PRO),
